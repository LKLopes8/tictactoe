...
$(function () {
    ...
    startNewGame = function () {
        //display to user that it is X's turn
        $("#display").text("Player X Goes");
        turn = "X";
        score = {"X": 0, "O": 0};
        moves = 0;
    ...
    set = function () {
        ...
        if (win(score[turn])) {
            ...
            $("h1").text("Congratulations Player " + turn + " Wins!");
            startNewGame();
            ...
            turn = turn === "X" ? "O" : "X";
            //display to users whose turn it is
            $("#display").text("Player " + turn + " Goes");
        }
    },
    
    // reset game and header
    reset = function () {
        $("h1").text("Tic-Tac-Toe");
        startNewGame();
    },
